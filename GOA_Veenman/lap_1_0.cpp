              ...
              int *rowsol, int *colsol, cost *u, cost *v)
{
  ...
  for (i = 0; i < dim; i++)  
    for (j = 0; j < dim; j++)  
      ...
      {
        fprintf(stdout, "\n");
        fprintf(stdout, "negative reduced cost i %d j %d redcost %d\n", i, j, redcost);
        fprintf(stdout, "\n\ndim %5d - press key\n", dim);
        fscanf(stdin, "%d", &wait);
        break; 
      }
  ...
  for (i = 0; i < dim; i++)  
    ...
    {
      fprintf(stdout, "\n");
      fprintf(stdout, "non-null reduced cost i %d soli %d redcost %d\n", i, rowsol[i], redcost);
      fprintf(stdout, "\n\ndim %5d - press key\n", dim);
      fscanf(stdin, "%d", &wait);
      break; 
    }
  ...
  for (i = 0; i < dim; i++)  
    ...
    {
      fprintf(stdout, "\n");
      fprintf(stdout, "column matched more than once - i %d soli %d\n", i, rowsol[i]);
      fprintf(stdout, "\n\ndim %5d - press key\n", dim);
      fscanf(stdin, "%d", &wait);
      break; 
    }
  ...
  for (i = 0; i < dim; i++)  
    ...
    {
      fprintf(stdout, "\n");
      fprintf(stdout, "error in row solution i %d soli %d solsoli %d\n", i, rowsol[i], colsol[rowsol[i]]);
      fprintf(stdout, "\n\ndim %5d - press key\n", dim);
      fscanf(stdin, "%d", &wait);
      break; 
    }
  ...
  for (j = 0; j < dim; j++)  
    ...
    {
      fprintf(stdout, "\n");
      fprintf(stdout, "error in col solution j %d solj %d solsolj %d\n", j, colsol[j], rowsol[colsol[j]]);
      fprintf(stdout, "\n\ndim %5d - press key\n", dim);
      fscanf(stdin, "%d", &wait);
      break; 
    }
